        ...
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            ...
            className={`transition-colors ${isEditing ? 'cursor-pointer' : 'cursor-default'} ${
              star <= (hoveredValue || value) ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'
            }`}
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          >
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Rate your experience with the {type}</p>
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg text-white transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed ${
                  isDoctor ? 'bg-blue-600 hover:bg-blue-700' : 'bg-green-600 hover:bg-green-700'
                }`}
              >

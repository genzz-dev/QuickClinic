  ...
  if (verificationStatus === 'manual_review') {
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Manual Review Process</h2>
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6 max-w-md mx-auto">
          <p className="text-yellow-800 font-medium mb-2">
            Verification failed through OTP in Google Maps. We will use manual review, which will
            take up to 1 month.
          </p>
          <p className="text-yellow-700 text-sm">
            Our team will manually verify your clinic details and contact you once the process is
            complete.
          </p>
        </div>
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Complete the verification process to activate your clinic</p>
      </div>

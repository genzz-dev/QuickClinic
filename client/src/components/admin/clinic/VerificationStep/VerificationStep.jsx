		...
		return (
			<div className="text-center py-12">
				...
				<p className="text-gray-600 mb-4">
					Your clinic has been verified and is now active. Redirecting to
					dashboard...
				</p>
			...
			<div className="text-center py-12">
				...
				<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6 max-w-md mx-auto">
					<p className="text-yellow-800 font-medium mb-2">
						Verification failed through OTP in Google Maps. We will use manual
						review, which will take up to 1 month.
					</p>
					<p className="text-yellow-700 text-sm">
						Our team will manually verify your clinic details and contact you
		...
		return (
			<div className="text-center py-12">
				...
				<p className="text-gray-600 mb-6">
					Unable to verify your clinic at this time. Please try again later or
					contact support.
				</p>
				<button

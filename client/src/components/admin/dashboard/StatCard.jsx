...
const StatCard = ({ icon: Icon, title, value, color, bgColor, iconColor }) => (
  <div className={`${bgColor} rounded-xl p-4 border border-opacity-20 hover:shadow-md transition-all duration-300 cursor-pointer group`}>
      ...
      <div className="flex-1">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className={`text-2xl font-bold ${iconColor.replace('600', '700')} group-hover:scale-105 transition-transform duration-200`}>
              {value}
            </p>
          </div>
        </div>

...
const specialties = [
  ...
  { name: 'Neurology', icon: Brain, color: 'text-gray-600', bgColor: 'bg-gray-50' },
  { name: 'Ophthalmology', icon: Eye, color: 'text-gray-600', bgColor: 'bg-gray-50' },
  { name: 'General Medicine', icon: Stethoscope, color: 'text-gray-600', bgColor: 'bg-gray-50' },
  { name: 'Orthopedics', icon: Activity, color: 'text-gray-600', bgColor: 'bg-gray-50' },
  { name: 'Dermatology', icon: Shield, color: 'text-gray-600', bgColor: 'bg-gray-50' }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-2 text-blue-600">
                ...
                <span className="text-sm font-medium">Verified Healthcare Network</span>
              </div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-xl">
                Connect with verified healthcare professionals, schedule appointments seamlessly, and access quality medical care with confidence.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 font-medium">Verified Doctors</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-gray-900">{stats.totalClinics}</div>
                <div className="text-sm text-gray-600 font-medium">Partner Clinics</div>
              </div>
              <div className="text-center">
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-lg p-8">
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-semibold text-gray-900">Find Healthcare Providers</h2>
                <p className="text-gray-600 mt-1">Search doctors and clinics near you</p>
              </div>
                      ...
                      {suggestions.slice(0, 6).map((suggestion, index) => (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="font-medium text-gray-900">{suggestion.name || suggestion}</div>
              ...
              <div className="space-y-3">
                <h3 className="font-medium text-gray-900">Popular Specialties</h3>

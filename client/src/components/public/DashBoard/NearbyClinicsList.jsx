...
import { Building2, MapPin, Phone, Shield, Users } from 'lucide-react';
    ...
    <section className="py-16 bg-gray-50">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-12">
          <h2 className="text-3xl font-bold text-gray-900">Verified Medical Facilities</h2>
          <p className="text-gray-600">Trusted healthcare clinics in your area</p>
        </div>
          ...
          {clinics.map((clinic) => (
            ...
            >
              <div className="p-6">
                ...
                <h3 className="font-semibold text-gray-900 mb-3">{clinic.name}</h3>

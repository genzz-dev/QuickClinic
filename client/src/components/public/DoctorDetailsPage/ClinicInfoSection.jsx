              ...
              <div className="space-y-2">
                {clinic.contact.phone && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-600 text-sm">{clinic.contact.phone}</span>
                  </div>
                )}
                {clinic.contact.email && (
                  <div className="flex items-center gap-2">
                    <Mail className="w-4 h-4 text-gray-500" />
                    <span className="text-gray-600 text-sm">{clinic.contact.email}</span>
                  </div>
                )}
              </div>
            )}
              ...
              <div className="mt-3">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {clinic.facilities.length > 3 && (
                    <span className="text-xs text-gray-500">+{clinic.facilities.length - 3} more</span>
                  )}
                </div>
              </div>
            )}

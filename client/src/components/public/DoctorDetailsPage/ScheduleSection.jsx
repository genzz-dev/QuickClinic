    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-6">
        ...
        <div className="space-y-2">
          {orderedWorkingDays.map((day, index) => (
            ...
            >
              <span className="font-medium text-gray-700 capitalize">{day.day}</span>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {schedule.breaks.map((breakTime, index) => (
              ...
              >
                <span className="font-medium text-gray-700 capitalize">{breakTime.day}</span>
                <span className="text-gray-600">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-md border-l-4 border-blue-500">
        <p className="text-sm text-blue-700">
          <strong>Note:</strong> Schedule information is for reference only. Please book an
          appointment to confirm availability.
        </p>
      </div>
    </div>
  );

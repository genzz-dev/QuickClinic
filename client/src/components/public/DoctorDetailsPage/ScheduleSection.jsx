...
import { Clock, Calendar, Coffee, Plane } from 'lucide-react';
...
const ScheduleSection = ({ schedule }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {/* Working Days */}
      <div className="mb-6">
        <h4 className="text-lg font-medium text-gray-800 mb-3">Working Hours</h4>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {schedule.breaks.map((breakTime, index) => (
              <div key={index} className="flex justify-between items-center py-2 px-3 bg-orange-50 rounded-md border-l-4 border-orange-500">
                <span className="font-medium text-gray-700 capitalize">
                  {breakTime.day}
                </span>
                <span className="text-gray-600">
        ...
        <div>
          ...
          <div className="space-y-2">
            {schedule.vacations
              ...
              .map((vacation, index) => (
                <div key={index} className="py-2 px-3 bg-red-50 rounded-md border-l-4 border-red-500">

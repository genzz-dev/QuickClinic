        ...
        <div className="flex-1">
          <div className="text-center lg:text-left">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-4">
              ...
              <span className="text-xl text-blue-600 font-medium">{doctor.specialization}</span>
            </div>
            ...
            {doctor.yearsOfExperience && (
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-4">
                ...
                <span className="text-gray-700">{doctor.yearsOfExperience} years of experience</span>
              </div>
            )}

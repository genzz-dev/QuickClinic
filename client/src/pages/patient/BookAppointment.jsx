...
import { Calendar, Clock, User, MapPin, Phone, Star, AlertCircle, CheckCircle, X } from 'lucide-react';
import { getDoctorById, getDoctorSchedule, getDoctorAvailability, checkDoctorAvailability } from '../../service/publicapi'
...
const BookAppointment = () => {
    ...
    const checkDateAvailability = async () => {
      if (selectedDate && doctor) {
        try {
          ...
          setDateAvailability({ available: false, reason: 'Error checking availability' });
          setAvailableSlots([]);
        }
      }
    };
  ...
  const isWorkingDay = (date) => {
    ...
    const workingDay = schedule.workingDays.find(day => 
      day.day === dayName && day.isWorking
    );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {schedule && (
                <div className="mt-6 pt-6 border-t">
                  ...
                  <div className="space-y-1 text-xs">
                    {schedule.workingDays?.filter(day => day.isWorking).map(day => (
              ...
              {/* Current Vacations */}
              {schedule?.vacations?.filter(vacation => new Date(vacation.endDate) >= new Date()).length > 0 && (
                <div className="mt-6 pt-6 border-t">
              ...
              <form onSubmit={handleBooking} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    {generateAvailableDates().slice(0, 21).map((date) => {

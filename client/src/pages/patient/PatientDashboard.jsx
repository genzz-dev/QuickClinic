    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="py-12 bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-900 text-white">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 px-4">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold mb-2 drop-shadow">Welcome to <span className="text-yellow-300">Quick Clinic</span></h1>
            <p className="text-lg mb-4 font-medium">Your health, in one place — effortless, secure, and modern.</p>
            <div className="flex flex-wrap gap-2 mt-4">
              ...
              <span className="inline-flex items-center px-3 py-1 bg-white/10 rounded-full font-medium text-sm">
                <ClipboardList className="h-4 w-4 mr-1 text-blue-200" /> Seamless Prescriptions & Visits
              </span>
            </div>
          </div>
          <div className="flex flex-col items-center">
            ...
            <div className="text-lg font-semibold">{patientData?.firstName} {patientData?.lastName}</div>
            <div className="text-sm">{calculateAge(patientData?.dateOfBirth)} years | {patientData?.gender ? patientData.gender.charAt(0).toUpperCase() + patientData.gender.slice(1) : null}</div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg border flex flex-col items-center text-center transition">
          ...
          <p className="text-gray-500">Only trusted, authenticated clinics and hospitals listed. Your health, our priority.</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg border flex flex-col items-center text-center transition">
          <Database className="h-10 w-10 text-green-500 mb-2" />
          <h3 className="text-lg font-semibold mb-2">All Health Records</h3>
          <p className="text-gray-500">Access and share all your medical records, lab reports, and prescriptions anytime.</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg border flex flex-col items-center text-center transition">
          <ClipboardList className="h-10 w-10 text-blue-500 mb-2" />
          <h3 className="text-lg font-semibold mb-2">Seamless Visits & Rx</h3>
          <p className="text-gray-500">Prescriptions and doctor visits are managed and organized for you—fast and safe.</p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div>
            ...
            <div className="text-sm text-blue-100">Locate Google-verified clinics closest to you.</div>
          </div>
        </button>
        <button
        ...
        >
          ...
          <div>
            ...
            <div className="text-sm text-green-100">Browse specialists with transparent ratings and profiles.</div>
          </div>
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="bg-white rounded-lg shadow-md border p-6">
            <div className="mb-3 flex gap-2 items-center">
              ...
              <span className="ml-auto bg-green-100 text-green-800 text-sm px-3 py-0.5 rounded-full">{futureAppointments.length}</span>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md border p-6">
            <div className="mb-3 flex gap-2 items-center">
              ...
              <span className="ml-auto bg-blue-100 text-blue-800 text-sm px-3 py-0.5 rounded-full">{pastAppointments.length}</span>
            </div>

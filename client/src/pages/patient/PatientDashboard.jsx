		...
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
					...
					<div>
						...
						<div className="flex flex-wrap gap-2 mt-4">
							<span className="inline-flex items-center px-3 py-1 bg-white/10 rounded-full font-medium text-sm">
								<Shield className="h-4 w-4 mr-1 text-yellow-200" /> Google
								Verified Clinics
							</span>
							<span className="inline-flex items-center px-3 py-1 bg-white/10 rounded-full font-medium text-sm">
								<Database className="h-4 w-4 mr-1 text-green-200" /> All Health
								Records In One Place
							</span>
							<span className="inline-flex items-center px-3 py-1 bg-white/10 rounded-full font-medium text-sm">
								<ClipboardList className="h-4 w-4 mr-1 text-blue-200" />{" "}
								Seamless Prescriptions & Visits
							</span>
						</div>
					</div>
			...
			<div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
				<div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg border flex flex-col items-center text-center transition">
					...
					<h3 className="text-lg font-semibold mb-2">
						Google Verified Clinics
					</h3>
					<p className="text-gray-500">
						Only trusted, authenticated clinics and hospitals listed. Your
						health, our priority.
					</p>
				</div>
				<div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg border flex flex-col items-center text-center transition">
					...
					<p className="text-gray-500">
						Access and share all your medical records, lab reports, and
				...
				<div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg border flex flex-col items-center text-center transition">
					...
					<p className="text-gray-500">
						Prescriptions and doctor visits are managed and organized for
						you—fast and safe.
					</p>
				</div>
			</div>
			...
			<div className="max-w-5xl mx-auto px-4 py-10">
				<h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
					<HeartPulse className="h-7 w-7 text-pink-500" /> Recent Appointments &
					Activity
				</h2>

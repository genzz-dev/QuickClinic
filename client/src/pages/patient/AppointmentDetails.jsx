...
const generatePrescriptionPDF = () => {
  ...
  try {
    ...
    doc.text('Digital Healthcare Prescription', 105, yPosition, { align: 'center' });
    
    yPosition += 8;
    doc.setFontSize(10);
    doc.text(`Prescription Date: ${new Date(prescription.date).toLocaleDateString('en-US', {
      weekday: 'long',
      month: 'long',
      day: 'numeric',
      year: 'numeric'
    ...
    if (prescription.followUpDate) {
      ...
      doc.setFontSize(11);
      doc.setFont('helvetica', 'normal');
      doc.text(`Next Appointment: ${new Date(prescription.followUpDate).toLocaleDateString('en-US', {
        weekday: 'long',
        month: 'long',
        day: 'numeric',
        year: 'numeric'
    ...
    doc.setFontSize(12);
    doc.setFont('helvetica', 'bold');
    doc.text(`Dr. ${appointment.doctorId?.firstName || ''} ${appointment.doctorId?.lastName || ''}`, 140, yPosition);
    yPosition += 6;
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    ...
    doc.setFontSize(8);
    doc.setFont('helvetica', 'italic');
    doc.text('This is a digitally generated prescription.', 105, yPosition, { align: 'center' });
    yPosition += 4;
    doc.text(`Prescription ID: ${prescription._id}`, 105, yPosition, { align: 'center' });
    yPosition += 4;
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-600 ml-7">{formatTime(appointment.startTime)} - {formatTime(appointment.endTime)}</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            {prescription.diagnosis && (
              <div className="mb-4">
                ...
                <p className="text-gray-600 bg-blue-50 p-3 rounded-md">{prescription.diagnosis}</p>
              </div>
            )}
            ...
            {prescription.notes && (
              <div className="mb-4">
                ...
                <p className="text-gray-600 bg-yellow-50 p-3 rounded-md">{prescription.notes}</p>
              </div>
            )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-2">
              <p><span className="font-medium">Name:</span> Dr. {appointment.doctorId?.firstName} {appointment.doctorId?.lastName}</p>
              <p><span className="font-medium">Specialization:</span> {appointment.doctorId?.specialization}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-2">
              <p><span className="font-medium">Clinic:</span> {appointment.clinicId?.name}</p>
              <div className="flex items-start">
                <MapPin className="h-4 w-4 text-gray-400 mr-1 mt-0.5" />
                <span className="text-sm text-gray-600">
                  {appointment.clinicId.address.formattedAddress || `${appointment.clinicId.address.city}, ${appointment.clinicId.address.state}`}
                </span>
              </div>

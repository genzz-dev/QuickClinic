...
import { getPatientProfile, updatePatientProfile, uploadHealthRecord } from '../../service/patientApiService';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900">{profile?.emergencyContact?.name || 'Not specified'}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900">{profile?.emergencyContact?.relationship || 'Not specified'}</p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900">{profile?.emergencyContact?.phoneNumber || 'Not specified'}</p>
                  )}
                </div>
              </div>
            </div>

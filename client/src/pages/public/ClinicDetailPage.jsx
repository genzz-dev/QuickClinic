import { CheckCircle, Loader, MapPin, Star, Stethoscope } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <StarRating type="clinic" id={clinicId} size="large" detailed={true} inline={false} />
      </div>
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Photos */}
            {clinic.photos && clinic.photos.length > 0 && <PhotoGallery photos={clinic.photos} />}

...
import { getSearchSuggestions, searchClinics, searchDoctors } from '../../service/publicapi';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {featuredDoctors.length > 0 && (
        <FeaturedDoctors doctors={featuredDoctors} navigate={navigate} />
      )}

      {nearbyClinic.length > 0 && <NearbyClinicsList clinics={nearbyClinic} navigate={navigate} />}

...
import { getClinicRatings, getDoctorRatings, getRatingStats } from '../../service/ratingApiService';
...
const AdminRatingsPage = () => {
  ...
  const RatingCard = ({ rating }) => (
    <div className="bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md transition-shadow">
      ...
      {rating.comment && <p className="text-gray-700 text-sm leading-relaxed">{rating.comment}</p>}
    </div>
  );
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <p className="text-2xl font-bold text-green-600">{clinicStats?.totalRatings || 0}</p>
            <p className="text-sm text-gray-600">Total Reviews</p>
          </div>

          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <p className="text-2xl font-bold text-purple-600">{clinicInfo?.doctors?.length || 0}</p>
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="space-y-4">
        {clinicRatings.length > 0 ? (
          clinicRatings.map((rating) => <RatingCard key={rating._id} rating={rating} />)
        ) : (

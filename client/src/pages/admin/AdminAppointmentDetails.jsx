        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="flex space-x-4 items-center">
            ...
            <div>
              ...
              {patientId?.gender && (
                <div className="text-xs text-gray-400 capitalize">{patientId.gender}</div>
              )}
            </div>
          </div>
          <div className="flex space-x-4 items-center">
            {doctorId?.profilePicture ? (
              ...
              <div className="h-14 w-14 rounded-full bg-green-100 flex items-center justify-center">
                <FiUser className="h-6 w-6 text-green-700" />
              </div>
            )}
            <div>
              <div className="font-semibold text-lg text-gray-900">
              ...
              <div className="text-xs text-gray-400">{doctorId?.specialization}</div>
            </div>
          </div>
        </section>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            {clinicId?.contact?.phone && (
              <div className="text-xs text-gray-400 mt-1">
                Clinic Phone: {clinicId.contact.phone}
              </div>
            )}
          </div>
        </section>
            ...
            <div className="flex gap-3">
              {reason && (
                <div className="flex flex-col flex-1 bg-yellow-50 border-l-4 border-yellow-400 rounded-md p-4">
                  <div className="flex items-center text-sm text-yellow-800 font-semibold mb-1">
              ...
              {notes && (
                <div className="flex flex-col flex-1 bg-blue-50 border-l-4 border-blue-400 rounded-md p-4">
                  <div className="flex items-center text-sm text-blue-800 font-semibold mb-1">

...
const UpdateClinic = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			setError(
				"Failed to update clinic. Please check your inputs and try again.",
			);
			console.error(err);
		} finally {
			setIsLoading(false);
	...
	const isAddressEditable =
		!clinicData.isVerified && !clinicData.googleMapsLink;
					...
					<div className="bg-white p-6 rounded-lg shadow-md">
						...
						{clinicData.isVerified && (
							<div className="mb-4 p-3 bg-green-50 text-green-700 border border-green-200 rounded-md flex items-center">
								<FiCheckCircle className="mr-2" /> This clinic is verified. The
								Google Maps link and address cannot be changed.
							</div>
						)}
							...
							{!isAddressEditable &&
								...
								clinicData.googleMapsLink && (
									<div className="mt-4 p-3 bg-blue-50 text-blue-700 border border-blue-200 rounded-md flex items-center">
										<FiAlertTriangle className="mr-2" /> Address is
										automatically synced from the Google Maps link and is not
										editable. To edit manually, please remove the link above.
									</div>
								)}
								...
								{!isAddressEditable &&
									...
									!clinicData.isVerified && (
										<div className="p-3 bg-yellow-50 text-yellow-700 border border-yellow-200 rounded-md flex items-center">
											<FiAlertTriangle className="mr-2" /> To enable manual
											address entry, ensure the clinic is not verified and no

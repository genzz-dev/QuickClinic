    ...
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <label
                  htmlFor="logo-upload"
                  className="cursor-pointer mt-2 inline-flex items-center justify-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  id="phone"
                  name="phone"
                  value={clinicData.contact.phone}
              ...
              <div>
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  value={clinicData.contact.email}
                  onChange={(e) => handleNestedChange('contact', e)}
                  className="w-full p-2 border border-gray-300 rounded-md"
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  id="website"
                  name="website"
                  value={clinicData.contact.website}
                  onChange={(e) => handleNestedChange('contact', e)}
                  className="w-full p-2 border border-gray-300 rounded-md"
                />
              </div>
              <div>
                <label htmlFor="gstNumber" className="text-sm font-medium text-gray-600 mb-1">
                  GST Number
                </label>
                <input
                  type="text"
                  id="gstNumber"
                  name="gstNumber"
                  value={clinicData.gstNumber}
                  onChange={handleInputChange}
                  className="w-full p-2 border border-gray-300 rounded-md"
                />
              </div>
              <div className="md:col-span-2">
                <label htmlFor="gstName" className="text-sm font-medium text-gray-600 mb-1">
                  GST Name / Registered Name
                </label>
                <input
                  type="text"
                  id="gstName"
                  name="gstName"
                  value={clinicData.gstName}
                  onChange={handleInputChange}
                  className="w-full p-2 border border-gray-300 rounded-md"
                />
              </div>
          ...
          {/* --- Location Card --- */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-700 border-b pb-4 mb-6 flex items-center">
              <FiMapPin className="mr-3" /> Location
            </h2>
            {clinicData.isVerified && (
              <div className="mb-4 p-3 bg-green-50 text-green-700 border border-green-200 rounded-md flex items-center">
                <FiCheckCircle className="mr-2" /> This clinic is verified. The Google Maps link and
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  disabled={clinicData.isVerified}
                />
              </div>
              ...
              {!isAddressEditable && !clinicData.isVerified && clinicData.googleMapsLink && (
                <div className="mt-4 p-3 bg-blue-50 text-blue-700 border border-blue-200 rounded-md flex items-center">
                  <FiAlertTriangle className="mr-2" /> Address is automatically synced from the
                  Google Maps link and is not editable. To edit manually, please remove the link
                  above.
                </div>
              )}
              ...
              <div className="border-t pt-4 mt-4">
                ...
                {!isAddressEditable && !clinicData.googleMapsLink && !clinicData.isVerified && (
                  <div className="p-3 bg-yellow-50 text-yellow-700 border border-yellow-200 rounded-md flex items-center">
                    <FiAlertTriangle className="mr-2" /> To enable manual address entry, ensure the
                    clinic is not verified and no Google Maps link is provided.
                  </div>
                )}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      value={clinicData.address.formattedAddress}
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="zipCode"
                      value={clinicData.address.zipCode}
                      onChange={(e) => handleNestedChange('address', e)}
                      className="w-full p-2 border border-gray-300 rounded-md disabled:bg-gray-100"
                      disabled={!isAddressEditable}
                    />
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-700 border-b pb-4 mb-6 flex items-center">
              <FiBriefcase className="mr-3" /> Facilities & Amenities
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {PREDEFINED_FACILITIES.map((facility) => (
                <div key={facility} className="flex items-center">
                  ...
                  />
                  <label htmlFor={`facility-${facility}`} className="ml-2 text-sm text-gray-600">
                    {facility}
                  </label>
                </div>
              ))}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {clinicData.photos.map((photo, index) => (
                <div key={index} className="relative group">
                  ...
                  <button
                    type="button"
                    onClick={() => handleDeletePhoto(typeof photo === 'string' ? photo : photo.url)}
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-700 border-b pb-4 mb-6 flex items-center">
              <FiClock className="mr-3" /> Opening Hours
            </h2>
            <div className="space-y-4">
              {daysOfWeek.map((day) => (
                <div
                  key={day}
                  className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center border-t md:border-t-0 pt-4 md:pt-0"
                >
                  <span className="font-medium text-gray-800 capitalize">{day}</span>
                  <div className="flex items-center space-x-4">
                    <input
                      type="time"
                      value={clinicData.openingHours[day]?.open || ''}
                      onChange={(e) => handleOpeningHoursChange(day, 'open', e.target.value)}
                      disabled={clinicData.openingHours[day]?.isClosed}
                      className="w-full p-2 border border-gray-300 rounded-md disabled:bg-gray-100"
                    />
                    <span>-</span>
                    <input
                      type="time"
                      value={clinicData.openingHours[day]?.close || ''}
                  ...
                  <div className="flex items-center justify-start md:justify-end">
                    <input
                      type="checkbox"
                      id={`${day}-closed`}
                      checked={clinicData.openingHours[day]?.isClosed || false}
          ...
          <div className="flex items-center justify-end space-x-4 pt-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-300 disabled:cursor-wait"
            >

...
const AdminDashboard = () => {
  ...
  const handleSendVerificationOTP = async () => {
    try {
      ...
      toast.error(err.response?.data?.message || `Failed to send verification code ${err}`);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="w-full  px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Clinic Overview</h2>
        ...
        {showGoogleMapsModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Add Google Maps Link</h3>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">A 6-digit code was sent to your registered phone.</p>
              </div>

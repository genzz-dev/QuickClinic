        ...
        <div className="mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Your profile is set up. Share your Doctor ID with clinic admins to join their clinic.
            </p>
          </div>

          {/* Doctor ID Card */}
          <div className="bg-white rounded-xl shadow-lg p-8 mb-10 flex flex-col items-center">
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">Your Doctor ID</h2>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 flex items-center">
            ...
            <div>
              ...
              <span className="text-red-700"> Share your Doctor ID only with trusted clinic admins. Don't post this ID publicly.</span>
            </div>
          </div>

          {/* Step Instructions */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h3 className="text-blue-800 font-semibold mb-2">How to join a clinic:</h3>
            <ul className="list-decimal list-inside text-blue-700 space-y-1 ml-2">
              ...
              <li>The admin will add you to their clinic from the dashboard.</li>
              <li>Once added, you will gain access to the clinic's features.</li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-xl shadow p-8 mb-8">
            ...
            {message.text && (
              <div className={`p-4 rounded mb-5 ${message.type === "success" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}>
                {message.text}
              </div>
            )}
            ...
            {isEditing ? (
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div>
                  ...
                  <div className="text-gray-900">{doctorProfile?.firstName} {doctorProfile?.lastName}</div>
                </div>
                <div>
                  <span className="font-semibold text-gray-700">Phone Number:</span>
                  <div className="text-gray-900">{doctorProfile?.phoneNumber}</div>
                </div>
                <div>
                  <span className="font-semibold text-gray-700">Specialization:</span>
                  <div className="text-gray-900">{doctorProfile?.specialization}</div>
                </div>
                <div>
                  <span className="font-semibold text-gray-700">Experience:</span>
                  <div className="text-gray-900">{doctorProfile?.yearsOfExperience} years</div>
                </div>
                <div>
                  <span className="font-semibold text-gray-700">Consultation Fee:</span>
                  <div className="text-gray-900">₹{doctorProfile?.consultationFee}</div>
                </div>
                <div>
                  <span className="font-semibold text-gray-700">Qualifications:</span>
                  <div className="text-gray-900">{doctorProfile?.qualifications?.join(', ')}</div>
                </div>
                {doctorProfile?.bio && (
                  <div className="md:col-span-2">

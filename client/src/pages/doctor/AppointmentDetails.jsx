  ...
  const startEditPrescription = () => {
    if (prescription) {
      setPrescriptionData({
        ...
        tests: prescription.tests && prescription.tests.length > 0 
          ? prescription.tests 
          : [{ name: '', instructions: '' }],
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="font-medium">{calculateAge(patientInfo.dateOfBirth)} years</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-600">Gender</p>
                          <p className="font-medium capitalize">{patientInfo.gender || 'Not specified'}</p>
                        </div>
                        <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="font-medium">{patientInfo.phoneNumber || 'Not available'}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="font-medium">{patientInfo.emergencyContact || 'Not available'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div key={index} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-600 capitalize">{record.recordType.replace('-', ' ')}</p>
                      ...
                      <form onSubmit={handlePrescriptionSubmit} className="space-y-6">
                        ...
                        <div>
                          ...
                          {prescriptionData.medications.map((medication, index) => (
                            <div key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                              <div>
                                <input
                                  type="text"
                        ...
                        <div>
                          ...
                          {prescriptionData.tests.map((test, index) => (
                            <div key={index} className="flex space-x-4 mb-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                              <div className="flex-1">
                                <input
                                  type="text"
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  {patientInfo && (
                    <p className="text-sm text-gray-600">
                      {calculateAge(patientInfo.dateOfBirth)} years • {patientInfo.gender || 'Gender not specified'}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-3">
                {appointment.patientId?.phoneNumber && (
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-600">{appointment.patientId.phoneNumber}</span>
                  </div>
                )}

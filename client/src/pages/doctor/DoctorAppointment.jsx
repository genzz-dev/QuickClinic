        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-600">Manage and view your patient appointments</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <span className={tabs.find(tab => tab.id === activeTab)?.color || 'text-gray-600'}>
            ...
            {currentAppointments.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500">
                  {activeTab === 'today' && "Check back later or refresh to see new appointments"}
                  {activeTab === 'upcoming' && "New appointments will appear here once they're scheduled"}
                  {activeTab === 'past' && "Completed appointments will be shown here"}
                </p>
              </div>
            )}
          </div>

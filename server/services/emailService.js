 ...
 */
export const sendAppointmentConfirmation = async (email, patientName, appointment, doctorName, clinicName) => {
  try {
 ...
 */
export const sendAppointmentUpdate = async (email, name, appointment, doctorName, clinicName, updateType) => {
  try {
